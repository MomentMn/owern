...
import AttendanceDialog from "/staffdevelop/components/training2/course-attendance-dialog.js";
let template=`
<div class="training-list">
	<div class="clearfix">
		...
		<span style="color:#83ca5d;font-size:16px;">总成本: $ {{totalCost}}</span>
		<el-button class="right" type="success" v-on:click="exportSummary" :disabled="!courses || courses.length < 1">汇总导出</el-button>
		<el-button 
	...
	<div>
		<el-table :data="courses" border v-loading="loading">
			...
			<el-table-column width="90" prop="absenteePayroll" label="工资补贴" align="center" :resizable="false"></el-table-column>
		</el-table>
	</div>
