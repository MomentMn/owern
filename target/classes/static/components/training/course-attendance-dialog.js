...
<el-dialog
    ...
    <div class="detail">
       ...
       <span>Total {{ course.trainingHours }} hours</span>
    ...
    <el-table :data="teachers" :cell-class-name="setCellClass" v-loading="uploadLoading" element-loading-text="正在上传">
        ...
        <el-table-column prop="name" label="Teacher"  align="center"></el-table-column>
        <el-table-column prop="attachment" label="Portfolio and Reflection" align="center">
        ...
        <el-table-column label="Grant" align="center" width="120">
            <template slot-scope="scope">
                <el-input v-model="scope.row.grant" size="small" :disabled="scope.row.status == 3"></el-input>
            </template>
        </el-table-column>
        <el-table-column label="Absentee Payroll" align="center" width="120">
            <template slot-scope="scope">
    ...
    <div style="width:400px;margin:45px auto 0px" class="clearfix" v-if="!teachers || teachers[0].status!=3">
        <el-button class="left" v-on:click="cancelAttendance">Cancle</el-button>
        <el-button type="success" class="right" v-on:click="confirmAttendance">Confirm and Save</el-button>
    </div>
</el-dialog>
`;
