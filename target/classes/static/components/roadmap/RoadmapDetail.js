import RoadmapTraindialog from "/staffdevelop/components/roadmap/TrainingDialog.js"
//vue 组件
let  template=
`
...
<div class="roaddetail-wraper"  v-loading="loading">
     <div class="title">
         <div style="display: inline-block">
          ...
          <div><span class="name">Teacher's name: {{teacher.teacherName}}</span> <span class="level">Current Level: {{teacher.dutyName}}</span></div>
        </div>
        <div　class="buttons" style="display: inline-block;float:right;margin-right:30px;">        
            <el-button type="success" @click="saveEvidence()" v-if="visiableButton==1">　Save　</el-button>
     ...
     <div class="content">
       <div class="cont_wraper">       
            <table>
                   ...
                   <template v-for="item2 in item.childs">
                     <!-- 二级 -->
                       <tr class="second-level-tr"> 
                         ...
                         <td style="width: 15%"> <div class="second-level">Area of improvement </div></td>
                         <td style="width: 15%"><div class="second-level">Action Plan </div></td>
                         <td style="width: 15%"> <div class="second-level">Evidence </div></td>
                         <td style="width: 8%"><div class="second-level"> Status </div></td>                 
                         <td style="width: 8%"><div class="second-level"> Review Date </div></td>
                         <td style="width: 8%"> 
                         <div class="second-level" >
                         <el-button type="success" size="small" @click="addTraining(item2.dutyLevelSkillId,item.skillName,item2.skillName,item2.dutyLevelSkillId)" v-if="teacher.roleType!=='teacher'&& item2.editable==1">Add Training</el-button>
                         <span v-if="teacher.roleType==='teacher' || teacher.roleType!=='teacher'&& item2.editable==0">Training Plan</span>
                         </div></td>
                       </tr>
                            ...
                            <tr> 
                                 ...
                                 <td > 
                                     <div class="third-level" v-if="item3.status==1">
                                        Completed on<br> {{item3.markCompleteDateDesc}} 
                                     </div>
                                     <div class="third-level" v-if="item3.status==0 && teacher.roleType!=='teacher'&&item3.editable==1">
                                        <el-button type="success" size="small" @click="markAsComplete(item3.id)">mark As<br/>Complete</el-button> 
                                     </div>
                                 </td>                
                                 <td > 
               ...
               <!--汇总-->
                <tr> 
                  <td colspan="7"><div class="summary"><span>Total Planned Training Hour: {{ teacher.trainHours||0}} h</span></div></td>
               </tr>    
             </table>          
       </div>
     </div> 
