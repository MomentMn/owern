...
<div class="appraisal-info">
    <div class="head">
        ...
        <div class="head-right right">
            ...
            <el-button v-show="showFlag" class="bt" type="success" @click="submit">Submit</el-button>
            <el-button v-show="!showFlag" class="bt" type="success" @click="save">Save</el-button>
            <el-button v-show="showFlag && !teacherShow" class="bt" type="success" @click="exportInfo">Export</el-button>
        </div>
    </div>
    <div class="appraisal-body">
        <textarea v-show="!teacherShow && showFlag" class="appraisal-comment" placeholder="Appraiser's Comment" @blur="commentChange">{{evaluatorComment}}</textarea>
        <el-tabs v-show="showFlag" v-model="activeName" @tab-click="handleClick" v-loading="loading">
            <el-tab-pane label="Checklist" name="1">
                <div class="raing-div">
                    Rating scale:
            ...
            <el-tab-pane label="Reflection" name="2">
                <div class="content_appraisal_table">
                    <table>
                        <tr> 
                            <td colspan="5">
                        ...
                        <tr> 
                            ...
                            <td style="width: 34%"> <div class="second-level text-center">Strength and Achievements</div></td>
                            <td style="width: 34%"><div class="second-level text-center">Evidence </div></td>
                            <td style="width: 14%"> <div class="second-level text-center">Period/Date </div></td>
                        ...
                        <tr> 
                            ...
                            <td>
                                <div class="third-level">
                                    <el-button type="danger" plain @click="changeReflection('add',null,$event)"><i class="el-icon-plus el-icon--left"></i>Add New Reflection</el-button>
                                </div>
                            </td>
                            <td>
                                <div></div>
            ...
            <el-tab-pane label="Improvement Plan" name="3">
                <div class="content_appraisal_table">
                    <table>
                        <tr> 
                        ...
                        <tr>
                            <td style="width: 35%">
                                <div class="third-level">
                                    <el-button type="danger" plain @click="addPlan"><i class="el-icon-plus el-icon--left"></i>Add New Target</el-button>
                                </div>
                            </td>
            ...
            <div class="content_appraisal_table">       
                 <table v-for="(skill,bindex) in skillList">
                    ...
                    <tr v-for="(child,cindex) in skill.child"> 
                        ...
                        <td style="width: 20%"> 
                            <div v-if="child.depth == 2" class="second-level text-center"> Select As Target </div>
                            <div v-if="child.depth == 3" class="third-level text-center"> 
        ...
        submit(){
                ...
                for(let j=0;j<skill.child.length;j++){
                    ...
                    if(child.depth == 3){
                        if(child.evidence == null || child.evidence.trim() == ''){
                            this.$message.error('checklist evidence not be empty');
                            return;
                        }
                        if(child.raing == null){
                            this.$message.error('checklist rating not be null');
                            return;
                        }
                    }
                }
            ...
            for(let i=0;i<this.reflectionList.length;i++){
                ...
                if(reflection.strengthsOrAchievements == null || reflection.strengthsOrAchievements.trim() == ''){
                    this.$message.error('reflection strengthsOrAchievements not be empty');
                    return;
                }
                if(reflection.evidence == null || reflection.evidence.trim() == ''){
                    this.$message.error('reflection evidence not be empty');
                    return;
                }
                if(reflection.date == null){
                    this.$message.error('reflection period/date not be null');
                    return;
                }
            }
            for(let i=0;i<this.planList.length;i++){
                ...
                if(plan.depth == 3){
                    if(plan.actionPlan == null || plan.actionPlan.trim() == ''){
                        debugger
                        this.$message.error('improvement plan actionPlan not be empty');
                        return;
                    }
                    if(plan.targetCompleteDate == null){
                        this.$message.error('improvement plan targetCompleteDate not be null');
                        return;
                    }
                    if(!this.teacherShow){
                        if(plan.areaOfImprovement == null || plan.areaOfImprovement.trim() == ''){
                            this.$message.error('improvement plan areaOfImprovement not be empty');
                            return;
                        }
                    }
                }
