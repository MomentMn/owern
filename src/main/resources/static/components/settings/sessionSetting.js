...
<div style="width:96%;margin-top: 10px;padding:0 2%;height:1000px;">
    <div style="width:100%;height:40px;margin-bottom: 15px;">
      ...
      <el-button type="success" size="medium" style="float:right;" v-on:click="saveTimeSetting" :disabled="sessionSetting.flag">Save</el-button>
    </div>    
    <div class="seesion-setting-class">
        
        <div style="padding-left: 5%;height: 50px;padding-top: 20px;color:#E6B062">MID-YEAR</div>
        <div class="seesion-setting-item-class">
            <span>Appraisal Start Date</span>
            <el-date-picker class="date-picker"  
                    ...
                    type="date" 
                    v-on:change="pickChange(index)" placeholder="pick date">
            </el-date-picker>
        </div>
        <div class="seesion-setting-item-class">
            <span>Teacher's Self Evaluation End Date</span>
            <el-date-picker class="date-picker" 
        ...
        <div class="seesion-setting-item-class">
            <span>Appraiser's Review End Date</span>
            <el-date-picker class="date-picker" 
        ...
        <div style="padding-left: 5%;height: 50px;padding-top:45px;color:#E6B062">Annual</div>
        <div class="seesion-setting-item-class">
            <span>Appraisal Start Date</span>
            <el-date-picker class="date-picker"  
    ...
    methods:{
        ...
        saveTimeSetting(){
            ...
            server.post(url,this.sessionSetting).then(res => {
                ...
                this.$message.error("Please pick the right time");
                this.loading = false;
            });
        }
    }
