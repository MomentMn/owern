...
<div class="training-need">
	<div>
		...
		<el-select v-model="group" style="width:120px;" v-on:change="handleDutyChange" :disabled="loading">
			...
			<div class="table" v-for="(subItem, subIndex) in item.subCategorys" :key="subIndex">
				...
				<div class="members td clearfix">
					...
					<div class="new-button">
						<el-button v-on:click="openCourseDialog(subItem)">Add Training</el-button>
					</div>
				</div>
			</div>
		</div>
